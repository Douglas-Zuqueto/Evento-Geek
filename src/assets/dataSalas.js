...
import room9 from './images/NarutoShippuden4.jpg';
  ...
  export const listaSalas = [
      ...
      { id: 7, imageurl: room7, comp:true, name: "Rocket League", price: "R$15,00", reward: "R$1500,00", desc:"Carros, futebol e muita ação! Rocket League combina velocidade e esportes em uma experiência única. Prepare-se para acelerar e marcar gols incríveis." },
      { id: 8, imageurl: room8, comp:true, name: "Dragonball", price: "R$10,00", reward: "R$1000,00", desc:"Entre no mundo de Dragon Ball! Nesta sala, você encontrará fãs apaixonados pela saga, discussões sobre personagens e até mesmo torneios de luta." },
      { id: 9, imageurl: room9, comp:true, name: "Naruto UTNS4", price: "R$10,00", reward: "R$1000,00", desc:"Ninjas, jutsus e batalhas épicas! Se você é fã de Naruto, esta sala é o lugar certo para mergulhar no universo shinobi e testar suas habilidades." }
    ];